...
namespace PCGD.Controllers
{
    public class HocPhanController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,MaHP,TenHP,HocKi,SoTC,SoTCBatBuoc,SoTCTuChon,SoTietLT,SoTietTH")] HocPhan hocPhan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,MaHP,TenHP,HocKi,SoTC,SoTCBatBuoc,SoTCTuChon,SoTietLT,SoTietTH")] HocPhan hocPhan)
        {
            if (ModelState.IsValid)
            {
